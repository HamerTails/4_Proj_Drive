...
// Suppression définitive (gère aussi les dossiers récursivement)
router.delete("/:id/permanent", authenticateToken, async (req, res) => {
    ...
    try {
        ...
        // suppression des fichiers physiques + calcul de la place libérée
        ...
        res.json({ message: "Suppression permanente effectuée", freed_space: totalSizeFreed });
    } catch (err) {
        await client.query("ROLLBACK");
